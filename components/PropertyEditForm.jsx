...
const PropertyEditForm = () => {
    ...
    const [fields,setFields]=useState({
      //set default values to the propertyEdit form
      name: "",
      type: "",
      description: "",
    location: {
    ...
    useEffect(() => {
        ...
        const fetchPropertyData = async () => {
            try {
                ...
                //check for null values and replace with empty string
    ...
    const handleChange =(e) =>{ 
      ...
      //check if nested property is nested
      if(name.includes(".")){
    ...
    const handleAmenitiesChange =(e) =>{
      ...
      //Clone to the current array
      const updatedAmenities=[...fields.amenities];
      
      //Edit Value to the array
      if(checked){
